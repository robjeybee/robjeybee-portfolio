        ...
        <div className="mobile-content-container desktop-content-container">
          <div className="projects-intro text-align-center text-align-left">
            ...
            <div className="desktop-container-70pc">
              <p className="margin-bottom font-size-20 line-height-30 line-height-26">
                I've built and collaborated on projects using React, Firebase,
                and PostgreSQL, to create seamless front-end user experiences
                and robust back-end functionality. Whether working in a team or
                independently, I prioritise clean, efficient code and solving
                real-world problems.
              </p>
            </div>
          </div>
          <div className="main-project margin-bottom">
            ...
            <div className="desktop-container-50pc">
              <h2>KitStack</h2>
              <p className="line-height-26 stack-color">
                Stack: HTML, Tailwind CSS, React, Firebase
              </p>
              <p className="font-size-20 line-height-30 line-height-26">
                Built with React, Tailwind CSS and Google Firebase to deliver a
                minimal viable product that allowed users to sign up and perform
                CRUD functionality for their football shirt collections.
              </p>
              <a
                className="cta-link"
                href="https://github.com/robjeybee/kitStack"
                target="_blank"
              >
                GitHub Repo
              </a>
          ...
          <div className="secondary-projects">
            <div className="secondary-project margin-bottom">
              ...
              <p className="line-height-26 stack-color">
                Stack: HTML, Vanilla CSS, React, Axios
              </p>
              <p className="font-size-20 line-height-30 line-height-26">
                Constructed components in React to create a single-page
                application that returns images using a NASA API. Deployed on
                Vercel.
              </p>
              <a
                className="cta-link mobile-project-cta-margin"
                href="https://react-technical-test-5805v5dnh-rjrobbie.vercel.app/"
                target="_blank"
              >
                Live demo
              </a>{" "}
              <a
                className="cta-link"
                href="https://github.com/robjeybee/react-technical-test"
                target="_blank"
              >
                GitHub Repo
              </a>
            ...
            <div className="secondary-project">
              ...
              <h2>Music Library</h2>
              <p className="line-height-26 stack-color">
                Stack: Postman, PostgeSQL, MySQL, Express.js
              </p>
              <p className="font-size-20 line-height-30 line-height-26">
              ...
              <a
                className="cta-link"
                href="https://github.com/robjeybee/music-library"
                target="_blank"
              >
                GitHub Repo
              </a>
